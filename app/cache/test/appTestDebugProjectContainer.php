...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('D:/xampp/xampp/htdocs/Music_site/app/cache/test/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'music_site', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string', 'set' => 'string', 'varbinary' => 'string', 'tinyblob' => 'text'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setProxyDir('D:/xampp/xampp/htdocs/Music_site/app/cache/test/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f6944401d995f4c1225f2d819c06766b9f8b38a48148c6a8028d03bb8006ab49');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/xampp/xampp/htdocs/Music_site/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/xampp/xampp/htdocs/Music_site/app/cache/test/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/xampp/htdocs/Music_site/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/xampp/xampp/htdocs/Music_site/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/xampp/htdocs/Music_site/app/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('D:/xampp/xampp/htdocs/Music_site/app/cache/test/sonata/admin', true);
    }
    ...
    /**
     * Gets the 'tms.menu.admin.menu' service.
     *
     * @return \TMS\MenuBundle\Admin\MenuAdmin A TMS\MenuBundle\Admin\MenuAdmin instance.
     */
    ...
    /**
     * Gets the 'tms.submenu.admin.submenu' service.
     *
     * @return \TMS\MenuBundle\Admin\SubmenuAdmin A TMS\MenuBundle\Admin\SubmenuAdmin instance.
     */
    ...
    /**
     * Gets the 'tms.userjoinpage.admin.user' service.
     *
     * @return \TMS\UserJoinPageBundle\Admin\UserAdmin A TMS\UserJoinPageBundle\Admin\UserAdmin instance.
     */
    ...
    /**
     * Gets the 'tms.userjoinpage.admin.usertype' service.
     *
     * @return \TMS\UserJoinPageBundle\Admin\UserTypeAdmin A TMS\UserJoinPageBundle\Admin\UserTypeAdmin instance.
     */
    protected function getTms_Userjoinpage_Admin_UsertypeService()
    {
        $instance = new \TMS\UserJoinPageBundle\Admin\UserTypeAdmin('tms.userjoinpage.admin.usertype', 'TMS\\UserJoinPageBundle\\Entity\\UserType', 'TMSUserJoinPageBundle:UserTypeAdmin');
    ...
    /**
     * Gets the 'tms.usertypemenu.admin.usertypemenu' service.
     *
     * @return \TMS\MenuBundle\Admin\UsertypemenuAdmin A TMS\MenuBundle\Admin\UsertypemenuAdmin instance.
     */
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\TMS\\UserJoinPageBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\TMS\\AuthorsBundle\\Resources\\config\\validation.yml')));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/xampp/xampp/htdocs/Music_site/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/xampp/xampp/htdocs/Music_site/app/cache/test/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54b60a3cb0f50')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/xampp/xampp/htdocs/Music_site/app/cache/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test',
            ...
            'debug.container.dump' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/xampp/xampp/htdocs/Music_site/app/cache/test/profiler',
            ...
            'router.resource' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/xampp/xampp/htdocs/Music_site/app/cache/test/doctrine/orm/Proxies',
