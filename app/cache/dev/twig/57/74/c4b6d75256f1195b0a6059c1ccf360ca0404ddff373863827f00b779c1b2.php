            ...
            <div class=\"col-sm-12\">
                <div class=\"row form-group\">
                    ...
                    <div class=\"col-sm-8 col-md-9 no_col_left_padding grey\"> 
                                ";
        // line 69
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "user_type", array()), 'widget');
        echo "
                    </div>
                </div>
            </div>
