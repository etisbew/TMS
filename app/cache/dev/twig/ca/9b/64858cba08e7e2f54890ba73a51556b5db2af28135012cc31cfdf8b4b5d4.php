...
/* TMSAuthorsBundle:Authors:new.html_150115.twig */
class __TwigTemplate_ca9b64858cba08e7e2f54890ba73a51556b5db2af28135012cc31cfdf8b4b5d4 extends Twig_Template
{
...
\t  <form action=\"";
        ...
        // line 32
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "anonymous", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "</div>
                        </div>
                        <div class=\"row form-group\">
                            ...
                            <div class=\"col-sm-6 no_col_left_padding\">";
        // line 36
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "pseudonym", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "</div>
                        </div>
\t\t\t\t\t\t<div class=\"row form-group\">
                            ...
                            <div class=\"col-sm-6 no_col_left_padding\">";
        // line 40
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "contribution", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "</div>
                        </div>
\t\t\t\t\t\t<div class=\"row form-group\">
                            <div class=\"col-sm-4 text-right text-left-xs field_label\">Completed_Year:</div>
                            <div class=\"col-sm-6 no_col_left_padding\"><input type=\"date\" class=\"form-control\" name=\"completed_year\" ></div>
                        </div>
\t\t\t\t\t\t<div class=\"row form-group\">
                            <div class=\"col-sm-4 text-right text-left-xs field_label\">Nationality:</div>
                            <div class=\"col-sm-6 no_col_left_padding\">";
        // line 48
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "nationality", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "</div>
                        </div>
\t\t\t\t\t\t<div class=\"row form-group\">
                            ...
                            <div class=\"col-sm-6 no_col_left_padding\">";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "citizen", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "</div>
                        </div>
                    </div>
...
";
    ...
    {
        return "TMSAuthorsBundle:Authors:new.html_150115.twig";
    }
    ...
    {
        return array (  146 => 66,  137 => 60,  126 => 52,  119 => 48,  108 => 40,  101 => 36,  94 => 32,  87 => 28,  75 => 21,  63 => 11,  60 => 10,  54 => 5,  50 => 4,  46 => 3,  41 => 2,  38 => 1,  33 => 69,  31 => 10,  26 => 8,  23 => 7,  21 => 1,);
    }
}
