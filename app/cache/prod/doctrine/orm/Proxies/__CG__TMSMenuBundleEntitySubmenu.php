...
namespace Proxies\__CG__\TMS\MenuBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Submenu extends \TMS\MenuBundle\Entity\Submenu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Submenu' . "\0" . 'id', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Submenu' . "\0" . 'description', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Submenu' . "\0" . 'href', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Submenu' . "\0" . 'action', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Submenu' . "\0" . 'menu');
        }
