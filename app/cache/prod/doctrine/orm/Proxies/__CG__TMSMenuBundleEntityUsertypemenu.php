 ...
 */
class Usertypemenu extends \TMS\MenuBundle\Entity\Usertypemenu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Usertypemenu' . "\0" . 'id', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Usertypemenu' . "\0" . 'user_type', '' . "\0" . 'TMS\\MenuBundle\\Entity\\Usertypemenu' . "\0" . 'menu');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Usertypemenu $proxy) {
